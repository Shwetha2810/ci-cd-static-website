pipeline {
    ...
    environment {
        DOCKERHUB_USERNAME = 'shwe12'
        DOCKER_IMAGE = "${DOCKERHUB_USERNAME}/canara_shwe"
        DOCKER_CONTAINER = 'canara_app_shwe'
    }
    ...
    parameters {
        ...
        string(name: 'RECEIVER_EMAIL', defaultValue: 'shwethamogaveera01@gmail.com', description: 'Comma-separated recipient emails')
    }
